...
namespace MessagePack.Formatters.DM
{
    ...
    public sealed class PersonFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::DM.Person>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::DM.Person value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            formatterResolver.GetFormatterWithVerify<global::DM.Gender>().Serialize(ref writer, value.Gender, options);
